...
load("/volume/projects/CV_gs_PLS/Data/mri_plexus_clinical_matrices_featnames.mat")
...
input.X_features_names       = feature_names{1}; % define names of features in X, if no names applicable, leave empty
input.Y_feature_names        = feature_names{2};
input.X_name                 = matrix_names{1};
input.Y_name                 = matrix_names{2};
