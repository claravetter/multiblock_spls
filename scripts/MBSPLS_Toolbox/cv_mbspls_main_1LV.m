...
function [preliminary_results_mean_file, analysis_folder] = cv_mbspls_main_1LV(datafile)
...
output.parameters_names = {'w', 'c_weights', 'weights', 'success', 'RHO', 'p', 'latent_scores', 'Vs_opt'};
...
%          output.final_parameters{n_LV,7} = [];
%          output.final_parameters{n_LV,8} = [];
%
%      case 'sum'
%
%
