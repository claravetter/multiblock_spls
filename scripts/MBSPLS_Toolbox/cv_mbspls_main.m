...
save([permutation_folder '/permutation_setup.mat'],'selection_train', 'mbspls_params','correlation_method', 'matrix_norm', 'size_sets_permutation', 'perm_coding', 'selection_retrain', 'correction_target', '-v7.3');
save([bootstrap_folder '/bootstrap_setup.mat'],'selection_train', 'mbspls_params', 'correlation_method', 'matrix_norm', 'size_sets_bootstrap', 'correction_target', '-v7.3');
                ...
                for ob=1:OB
                    ...
                    switch selection_retrain
                        ...
                        case 1 % retrain on entirety of folds
                            ...
                            [RHO_opt_collection(1,ob), weights_opt_collection(:,ob), Vs_opt_collection_temp, lVs_opt_temp] = cv_mbspls_full(OUT_matrices.train, OUT_matrices.test, c_weights_opt, mbspls_params, correlation_method, matrix_norm);
            ...
            for ob=1:OB
                ...
                switch selection_retrain
                    case 1 % retrain on entirety of outer folds
                        ...
                        [RHO_opt_collection(1,nn), weights_opt_collection(:,nn), Vs_opt_collection_temp, lVs_opt_temp] = cv_mbspls_full(OUT_matrices.train, OUT_matrices.test, c_weights_opt, correlation_method, matrix_norm);
                        Vs_opt_collection = cat(3, Vs_opt_collection, Vs_opt_collection_temp);
    ...
    if ~islogical(input.validation_set)
        ...
        switch input.validation_train
            case 1 % retrain
                ...
                [RHO_opt, weights_opt, ~, lVs_val] = cv_mbspls_full(OUT_matrices.train,OUT_matrices.test, c_weights_opt, correlation_method, matrix_norm);
                ...
                save([permutation_folder '/permutation_setup.mat'],'selection_train', 'mbspls_params','correlation_method', 'matrix_norm', 'size_sets_permutation', 'perm_coding', 'correction_target', '-v7.3');
                save([bootstrap_folder '/bootstrap_setup.mat'],'selection_train', 'mbspls_params','correlation_method', 'matrix_norm', 'size_sets_bootstrap', 'selection_retrain', 'correction_target', 'bs_method', '-v7.3');
