...
function [output_file] = dp_bash_parallel(spls_standalone_path, analysis_folder, type_analysis, mem_total, max_sim_jobs, queue_name, total_jobs, size_sets)

switch type_analysis
    case 'hyperopt'
        comp_path = [spls_standalone_path '/hyperopt/for_testing/hyperopt ',...
            '$SGE_TASK_ID $var_size_sets ' analysis_folder ];
    case 'permutation'
