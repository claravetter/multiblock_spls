...
function dp_visualize_data_multi_2020(IN)
...
if any(strcmp(IN.specific, 'sociodemographic') | all_jobs)
    [input, output, setup] = dp_sociodemographic_2020(IN);
end
...
if any(strcmp(IN.specific, 'behavior') | all_jobs)
    ...
    for i=1:size(input.selected_features,2)
        log_f(i,:) = contains(input.behavior_names(1,:), input.selected_features{1,i});
    end
