...
function dp_bash_main_job_10G(spls_standalone_path, project_folder, project_name, queue_name, queue_name_perm, variables_for_analysis, email)
...
fprintf(FID,['#!/bin/bash \n',...
    ...
    '#$ -l mem_free=10G       # This is how much memory you are requesting \n',...
    '#$ -l h_rss=10G          # This is the absolute memory limit \n',...
    ...
    'queue_name_perm=' queue_name_perm '\n',...
    'variables_for_analysis=' variables_for_analysis '\n',...
    '\n',...
    spls_standalone_path '/dp_spls_standalone/for_testing/dp_spls_standalone $spls_standalone_path $analysis_folder $queue_name_perm $variables_for_analysis']);
