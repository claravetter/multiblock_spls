        ...
        for i=1:size(temp_parameters,1)
            ...
            switch input.optimization_strategy
                case 'grid_search'
                    ...
                    first_line = strrep([input.name, ', LV ',num2str(i)], '_', ' ');
            ...
            switch input.matrix_norm
                case 0
                    criterion = 'Spearmans RHO';
                case 'fro'
                    criterion = 'Frobenius norm';
            end


            second_line = ['p-value (FDR-corrected) = ' num2str(temp_parameters{i,index_p}), ', ', criterion, ' = ', num2str(temp_parameters{i,index_RHO})];
